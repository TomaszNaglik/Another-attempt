...
public class PlanetShader extends ShaderProgram {
	private static final String VERTEX_FILE = "src/shaders/planetVertexShader.txt";
	private static final String FRAGMENT_FILE = "src/shaders/planetFragmentShader.txt";
